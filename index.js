...
function hisoblash() {
    ...
    let betonhajmi = natija * 0.15;

    if (boyi != 0 && eni != 0 && chuqurligi != 0) {
        document.getElementById("yuza").innerHTML = natija + " m<sup>2</sup>";
        document.getElementById("beton").innerHTML = betonhajmi + " m<sup>3</sup>";
        document.getElementById("hajm").innerHTML = v + " m<sup>3</sup>";
    }
...
function summa() {
    console.log(kerakli);
    let puliGeoM = document.getElementById("narxgeomembrana").value;
    let puliGeoT = document.getElementById("narxgeotextil").value;
    puliGeoM = Number(puliGeoM);
    puliGeoT = Number(puliGeoT);
    if (puliGeoM != 0 && puliGeoT != 0 && natija != 0) {

        let summaGeoM = natija * puliGeoM
        let summaGeoT = natija * puliGeoT
        let summaUmumiy = summaGeoM + summaGeoT
        document.getElementById("sumGeoM").innerHTML = summaGeoM
        document.getElementById("sumGeoT").innerHTML = summaGeoT
        document.getElementById("sumUmu").innerHTML = summaUmumiy
    }
}
